...
The data quality for these sources is considerably worse than for the inner Orion Nebula.
...
For the EON the derived correlation length \(r_0 = \SI{0.05}{pc}\) is \num{6} times smaller
...
while those in the Magellanic Clouds are shown in Figure~\ref{fig:strucfunc-fit-MC}
