...
In this section we present and describe the second-order structure results. The structure functions are plotted against separation in parsecs and we also show the posteriors of the turbulent parameters using the analysis discussed in section~\ref{sec:methods-apply}.
...
The correlation length for the Orion core is 0.07\(\pm\)0.01 pc, it has a \(\sigma^2\pos\) of 13\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 1.07\(\pm\)0.02.
At large scales there is a plateau around \SI{22}{km^{2}.s^{-2}} reached at \SI{0.25}{pc}.
Above separations of \SI{0.3}{pc} the structure function decays reaching a separation of \SI{0.5}{pc} with a value of \SI{7}{km^{2}.s^{-2}}.

In the Figure~\ref{fig:strucfunc-fit-M8}a we see that the Lagoon nebula presents a non-uni from behavior at small. 
In this range considered above the separation of \SI{0.005}{pc} (\(s_0\)=\SI{0.83}{\arcsecond}) there aren't points affected by the seeing.
The structure function shows the characteristic ascending values despite not being as uniform as the other regions.
The turbulent parameters that fits our model are a \(r_0\) of 1\(\pm\)0.2 pc, a \(\sigma^2\pos\) of 7\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 1.13\(\pm\)0.01.
...
From this point the structure function keeps going up until it reaches \SI{66}{km^{2}.s^{-2}} around \SI{20}{pc}.
...
The seeing is \SI{0.008}{pc} (\(s_0\)=\SI{1.3}{\arcsecond}) and there aren't many points that lie below.
The correlation length is 0.56\(\pm\)0.04 pc at a \(\sigma^2\pos\) of 18\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 1.14\(\pm\)0.01.
...
For this region the points are above the seeing value which is \SI{0.07}{pc} (\(s_0\)=\SI{0.23}{\arcsecond}) but the first 8 points lie below the true model.
At separations above \SI{0.4}{pc} the structure functions observed values coincide with the true model. 
The correlation length is 2\(\pm\)0.1 pc at a \(\sigma^2\pos\) of 37\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 0.76\(\pm\)0.02.
For scales above \SI{9}{pc} with a \(B(r)\) value of \SI{70}{km^{2}.s^{-2}} a periodic behavior is seen .
...
The correlation length is 4\(\pm\)0.2 pc at a \(\sigma^2\pos\) of 300\(\pm\)9 \(\text{km}^2 \text{s}^{-2}\) and an index of 0.84\(\pm\)0.04.
...
The correlation length is 3.4\(\pm\)0.3 pc at a \(\sigma^2\pos\) of 10\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 0.74\(\pm\)0.10.
The maximum \(B(r)\) value is \SI{18}{km^{2}.s^{-2}} at a separation of \SI{25}{pc}. 
From there \(B(r)\) values descends until \SI{14}{km^{2}.s^{-2}} at \SI{45}{pc}, then it rises for the next point at \SI{50}{pc} with a value of \SI{15}{km^{2}.s^{-2}} and finally the structure functions descends at \SI{9}{km^{2}.s^{-2}} for a separation of \SI{70}{pc}.
...
The correlation length is 4\(\pm\)0.4 pc at a \(\sigma^2\pos\) of 16\(\pm\)1 \(\text{km}^2 \text{s}^{-2}\) and an index of 0.88\(\pm\)0.14.
...
From this point the structure functions shows consistent values around \SI{24}{km^{2}.s^{-2}} and finally there is a rise in \(B(r)\) up to \SI{29}{km^{2}.s^{-2}} at a separation of \SI{91}{pc}.
...
The correlation length is 12\(\pm\)1 pc at a \(\sigma^2\pos\) of 56\(\pm\)2 \(\text{km}^2 \text{s}^{-2}\) and an index of 1.3\(\pm\)0.05.
...
The correlation length is 9\(\pm\)3 pc at a \(\sigma^2\pos\) of 81\(\pm\)25 \(\text{km}^2 \text{s}^{-2}\) and has an index of 1.3\(\pm\)0.05.
