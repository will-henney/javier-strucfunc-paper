...
(note the flat posterior histograms for \(s_0\) in Fig.~\ref{fig:corner-Galactic}bcd).
...
The most extreme case is the Extended Orion Nebula (Fig.~\ref{fig:strucfunc-fit-Galactic}b--d),
...
leading to large uncertainties in the determination of the power law slope \(m\).
...
To that end, the last column in Table~\ref{tab:Res} gives the FWHM seeing width in arcsec. 
