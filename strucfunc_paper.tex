...
\item The correlation length of the velocity fluctuations is always a small fraction
  (roughly 2\%) of the \hii{} region diameter, implying that turbulent energy
...
\item The power law slope of the structure function at scales smaller than
  the correlation length is \(m \approx 1 \pm 0.2\) for all regions,
...
\item On scales larger than the correlation length, a variety of behaviors are seen.
  ...
  for large-scale gradients in the amplitude of the velocity fluctuations
...
No flattening of the structure function at the largest scales was seen, but that is to be expected due to the finite box effect (see Appendix~\ref{sec:finite-box-effects}).
