...
\begin{figure*}
  ...
  \caption{
    ...
    M8 Lagoon: R. Jay Gabany (\url{https://www.cosmotography.com/index.html}).
    Carina: ESO/Digitized Sky Survey~2, Davide De Martin
    (\url{https://www.eso.org/public/images/eso0905b})
    NGC~346: NASA, ESA and A. Nota (ESA/STScI) \citep{Nota:2006x}.
    30 Doradus: Robert Gendler, Roberto Colombari,
    Hubble Legacy Archive, European Southern Observatories
    (\url{http://www.robgendlerastropics.com/Tarantula-HST-ESO.html}).
    Hubble~X:
    Hubble~V:
    NGC~595:
    NGC~604:
