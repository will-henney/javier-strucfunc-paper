...
uses an errors-in-variables model that is symmetric in \(X\) and \(Y\).
Thus the fitted relation between the underlying variables
...
Additionally, we fit a strictly linear relationship between
