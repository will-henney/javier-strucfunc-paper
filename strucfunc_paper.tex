...
\begin{abstract}
  ...
  of the observed \halpha\ centroid velocity field for
  a diverse sample of 9 \hii{} regions,
  spanning two orders of magnitude in size and luminosity,
  that are located in the Milky Way and other Local Group galaxies
  % How we did it
  By fitting a simple analytic model to the second-order spatial structure function
  of the velocity fluctuations, we extract three fundamental parameters:
  the plane-of-sky velocity dispersion,
  the correlation length,
  and the power law slope.
  We determine the credibility limits for these parameters in each region,
  taking into account the observational limitations of noise,
  ...
  No evidence is found for a steepening of the power law slope of the structure function
  in the transition from subsonic to supersonic turbulence,
  which may be due to the countervailing effect of projection smoothing.
  Ionized density fluctuations are too large to be explained by the action
  of the turbulence in most cases, with the exception of the highest
  luminosity sources.
