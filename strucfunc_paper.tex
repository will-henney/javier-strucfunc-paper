...
On the other hand, the magnitude of the velocity dispersion found by these authors much larger than we measure.
For instance, they find \(B(r) = \SI{278}{km^2.s^{-1}}\) at \SI{0.2}{pc}, whereas we find \(B(r) \approx \SI{2}{km^2.s^{-1}}\) at the same scale, which corresponds to a discrepancy of more than a factor of a hundred in \(\sigma^2\pos\).
...
\caption{The \(\sigma_{\text{pos}}\)-\(\sigma_{\text{los}}\) plane. The dotted line represents slope equal to unity and the dashed line represents a slope of two.}
