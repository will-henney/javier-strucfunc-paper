...
for which our own results yield \(B(r) / \sigma\los^2 \approx 0.7\) and \(1.3\),
respectively (our Figure~\ref{fig:strucfunc-fit-MC}a),
whereas they find \(B(r) / \sigma\los^2 \approx 2.0\) at all separations (see their Figure 15).
