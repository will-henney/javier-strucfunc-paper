...
%For the discussion of our results in the next paragraphs the small scales would refer to the separations \(r < r_0\) and large scales would refer to separations \(r > r_0\).
