...
\begin{figure*}
  ...
  \caption{
    ...
    for the velocity centroid images
...
we fit the model structure function described above (equation~\eqref{eq:sf-functional})
to each of the \hii{} regions in our sample.
