...
We therefore propose the following 2-parameter model
...
\subsection{Effects of observational limitations}
...
\subsection{Limitations of the model structure function}
...
The precise reasons of this change on the structure function at large-scales is out of the scope of this investigation.
...
At scales of several tens of pc the expansion of \hii{} regions is also a source of energy and bipolar flows, shocks, and jets inject energy at small scales, about one tenth of a pc.
\cite{2011MNRAS.413..705L} also discuss the possibility of turbulent motions initiated by champagne flows and stellar winds. 
...
All indices are above this theoretic value and the interpretation of this difference is that the analyzed regions do not comply with the properties established in the development of the turbulence theory.
...
There is a large increase in the temperature because of the photoionization and the density gradients with the pressure gradients accelerate the flow which occurs in multiple scale consequences of the fractal nature of the molecular cloud \citep{arthur2016turbulence}.
This would result in a inhomogeneous structure characteristic of \hii{ } regions as it is possible to observe in Figure~\ref{fig:hii-regions}.
The incompressible and subsonic conditions in the flow are clearly not meet since there is evidence of the presence of shock fronts and supersonic velocity values.
This a a consequences of the inhomogeneous structure mentioned in the paragraph above and other processes as O star winds and radiation pressure which would also aid in the stirring of the gas.
And as \hii{} regions are regarded as three-dimensional objects there is also the possibility of a sheet-like distribution which could overcome this assumption.

For all these reason is expected that \hii{} regions power-law indices do not follow the classic 0.67 value.
But despite the complex nature of \hii{} regions we observe a common pattern for the structure function and the value of the index falls in a certain limited range of values
