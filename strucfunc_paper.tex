...
\begin{abstract}
  ...
  of the turbulence in {\NEW{any}} but the highest luminosity sources.
...
\NEW{The uncertainty of each bin (blue error bars) is estimated
as the fractional error of the respective \(B\obs(r)\) value.
These values are indicated in the third column of the table given in the Appendix D. 
In the same table, the forth and fifth columns show, as multiples of their respective fractional error, additional weight at small and large scales. 
This is the case for the EON, and the regions observed using the FLAMES and the TAURUS instruments.}
