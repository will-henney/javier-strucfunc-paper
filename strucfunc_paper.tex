...
\begin{figure*}
  \centering
  \sffigggg{OrionS}{M8}{OrionLH}{CarC}
  \caption{
...
Corresponding plots for the remaining sources are given in Appendix~\ref{sec:addit-covar-corn}.

\subsection{Example results of model fitting to the Orion Nebula}
...
Figure~\ref{fig:corner-example-Orion} shows the covariances
between parameters in the model fit.
It can be seen that there are some significant correlations between parameters,
for example, 
...
together with additional details of the model fit to the structure function
...
The EON structure function is shown in Figure~\ref{fig:strucfunc-fit-Galactic}c.
...
\begin{figure*}
  \centering
  \sfcfigggg{OrionS}{M8}{OrionLH}{CarC}
  \caption{
