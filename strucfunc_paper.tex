...
and that \(\sigma\los\) is entirely due to expansion along the line of sight,
then the prediction is that \(\sigma\pos / \sigma\los \approx \shortsig{E} / (1 + \shortsig{E})\)
where \( \shortsig{E} = \longsig{E}\) is the RMS fractional
...
\begin{figure}
  ...
  \caption{
    ...
    showing co-variation in fractional fluctuations of
    emissivity, \(\sigma_E\),  and surface brightness, \(\sigma_S\)
    together with fluctuations in the plane of sky of the mean velocity,
    \(\sigma\pos\),
...
\begin{align}
  ...
  \sigma_E &=
  \frac{
    \biggl[ 3\bigl(\alpha + \alpha^{-1}\bigr)^2 - 4\bigl(1 + \alpha + \alpha^{-1}\bigr)\biggr]^{1/2}
  }{
    2 + \alpha + \alpha^{-1}
  }
  \\
