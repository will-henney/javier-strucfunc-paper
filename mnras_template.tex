...
The non-thermal broadening on the spectral emission lines also has been suggested as evidence of disorder motions along the line-of-sight (LOS).
\citet{smith1970} discovered that the line width of GEHRs was supersonic in the order of $\sigma \sim$ 17-26 km s\kms.
\citet{melnick1977,terlevich1981} have shown an empirical relationship between the line width and the integrated properties of the HII regions as the diameter or the luminosity ($R \sim \sigma ^{\sim 2}$ ; $L \sim \sigma ^{\sim 4}$).
...
Our results are compared with physical properties of each region, which reveal correlations between them, and are also compared with previous investigations.
With this work we aim to fill a gap in statistical analysis of turbulence between galactic and giant HII regions.
...
NGC 595 is the second brightest giant HII region in the M33 galaxy with a length of 300 pc.
...
For NGC 604 the index is 1.7 with a correlation length of 9 pc.
...
Figure \ref{fig:SF604} shows that the structure functions for NGC 604, follow a periodic behavior around 2$\sigma$.
...
For NGC 595 the values obtained are 1.55 and 8.8.
The structure function goes up until 30 pc, reaching values above 2$\sigma$ before falling.


For NGC 6822 regions, Hubble X and Hubble V, the $m$ index is 1.5 and 1.4, with a correlation length of 3.5 and 2.7 pc, respectively.
...
The galactic region Lagoon nebula \citep{Damiani:2017b} presents a correlation length of 1.5 pc and a index of 1.15.
...
M42 results shows an index of 0.75 with a correlation length of 0.65.
...
The power-law index the provided is 1.55$\pm$0.01.
...
\caption{M8 second-order structure functions for H$\alpha$ emission line \ref{fig:MM8}) from  \citet{Damiani:2017b} and \citet{1987A&A...176..338H}.
...
\caption{M42 second-order structure functions for H$\alpha$ emission line taken from \citet{1987A&A...176..347H} \ref{fig:MOrion}).
