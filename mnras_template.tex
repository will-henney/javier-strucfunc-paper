...
\title[Turbulence in H II regiosn]{Turbulence in compact to giant HII regions}
...
%The large lengths of astrophysical objects, ranging in scales from 10$^{6}$ to 10$^{17}$ m \citep{2010ApJ...710..853C}, and the high Reynolds numbers (Re), in the order of 10$^{4}$ and 10$^{9}$, of these objects \citep{lagrois2011} are related to the existence of turbulent flows.   
...
We measure the second-order velocity structure function for a number of more compact and lower luminosity regions:
the Orion Nebula \citep{arthur2016turbulence}; 
the Lagoon Nebula \citep{Damiani:2017b};
the Carina Nebula \citep{Damiani:2016a};
the Tarantula Nebula (30~Dor) in the LMC \citep{Castro:2018a}.

In order to study the structure function 
We include 
