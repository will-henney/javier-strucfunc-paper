...
We use data from \cite{1987A&A...176..347H} of the Orion Nebula (M42) located at 440 pc \citep{2008AJ....136.1566O}. Its physical and kinematics properties along its stellar population are well documented in the review of \cite{2001ARA&A..39...99O}. The main ionizing star is $\theta^{1}$Ori C (spectral type $\sim$O7) with fast stellar wind, and 3 B-type stars from the Trapezium cluster. The position of Orion near the side of the Orion Molecular Cloud (OMC-1) make it an ongoing star formation region and a example of a blister HII region \citep{arthur2016turbulence}.

Archival data from \cite{Damiani:2016a} and \cite{Damiani:2017b} are use to study the Carina nebula and Lagoon nebula, respectively.
...
The NGC 604 TAURUS-II observations were used by \cite{sabalisck1995supersonic}, \cite{tanco1997} and \cite{2019arXiv191203543M}.
...
It has approximately 250 stars of the OB type, 13 Supergiants and 9 WR \citep{1996AJ....111.1128M}, ten WRs confirmed with spectroscopy \cite{1993AJ....105.1400D}, nine of the WN type and a WC, located near the bright core of the region.
...
%\cite{2002MNRAS.329..481B} 39.42 38.95 38.21 38.30  39.46 37.36  37.08
...
\begin{table}
\begin{center}\caption{General statistical properties of the centroid velocities. a) \cite{tanco1997} b) \cite{2019arXiv191203543M} c) \cite{Castro:2018a} d) \cite{Damiani:2016a} e) \cite{Damiani:2017b} f) \cite{1987A&A...176..338H} g) \cite{1987A&A...176..347H}.} 
...
\caption{M8 second-order structure functions for H$\alpha$ emission line \ref{fig:MM8}) from  \cite{Damiani:2017b} and \cite{1987A&A...176..338H}. The figure also shows the structure functions presented in previous works \citep{1987ApJ...317..686O}. Same information as Figure \ref{fig:SF604}.}
\label{fig:SFM8}
\end{figure}
...
\caption{M42 second-order structure functions for H$\alpha$ emission line taken from \cite{1987A&A...176..347H} \ref{fig:MOrion}). he figure also shows the structure functions presented in previous works \citep{von1951methode,munch1958internal,arthur2016turbulence}. Same information as Figure \ref{fig:SF604}.}
\label{fig:SFM42}
\end{figure}
